<!DOCTYPE html>
	...
	<?php
		...
		if (staffInDB($_POST["username"], $_POST["password"]) == true) {
		...
		<h2> <?php echo("Sorry Incorrect Password Or Username"); ?></h2>
    		<?php echo('<a href="staffLogin.php"><button onMouseOver = "emphasize_func(this)" onMouseOut = "remove_func(this)">Login Again</button></a>'); }?>
		</div>
	</body>
</html>
